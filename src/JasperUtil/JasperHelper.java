...
public class JasperHelper {
     ...
     * @param type
     */
    private static void prepareReport(JasperReport jasperReport, PrintType type) {
            switch (type){
                case EXCEL_TYPE:
                    try {
     ...
     * @throws JRException
     */
    private static void exportExcel(JasperPrint jasperPrint, String defaultFilename,
     ...
     * @param type              导出的数据类型
     * @param defaultFilename   导出的文件名称
     * @param file              Jasper模板文件
     * @param parameters        Jasper模板文件需要的参数
     * @param conn              Jasper 需要的数据库连接
     ...
     * @param type              导出的数据类型
     * @param defaultFilename   导出的文件名称，导出HTML的时候要特别注意，要带上路径
     * @param file              jasper模板文件
     * @param parameters        jasper模板需要的参数
     * @param datas             Jasper模板的填充数据
     * @param response          response
     */
    @Deprecated
    public static void export( PrintType type, String defaultFilename, File file,
                               Map parameters,Collection datas, HttpServletResponse response) {
